  ...
  map.addLayer({
    ...
    paint: {
      "fill-color": [
        ...
        ["get", "projectType"],
        "carbon",
        SITE_COLORS.carbon.fill,
        "biodiversity",
        SITE_COLORS.biodiversity.fill,
        "#888888",
      ],
      "fill-opacity": 0.32,
    },
  ...
  map.addLayer({
    ...
    paint: {
      "line-color": [
        ...
        ["get", "projectType"],
        "carbon",
        SITE_COLORS.carbon.outline,
        "biodiversity",
        SITE_COLORS.biodiversity.outline,
        "#555555",
      ],
      "line-width": 1.75,
    },
  ...
  useEffect(() => {
    ...
    const handleStyleLoad = () => {
      ...
      if (!activeProjectIds || activeProjectIds.size === 0) {
        ...
        const idsList = Array.from(activeProjectIds).flatMap((id) => [
          id,
          String(id),
        ]);
        const visibleFilter = [
